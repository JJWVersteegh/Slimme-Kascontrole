...
<section id="hoe-het-werkt" style="background:#f8fafc">
  <div class="container" style="text-align:center">
    ...
    <h2>VvE kascontrole in <em>drie stappen</em></h2>
    ...
    <div class="steps-grid">
      <div class="step-card">
        ...
        <p>Maak gratis een account aan en upload de financiële stukken van uw VvE — jaarrekening, bankafschriften of het overzicht van uw beheerder als PDF, Excel of CSV.</p>
      </div>
      <div class="step-card">
      ...
      <div class="step-card">
        ...
        <p>Ontvang direct uw professionele kascontrolerapport met volledige controle van elke post — klaar voor de ALV van uw VvE.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- FOOTER -->
<footer>
  <a href="/" class="nav-logo" style="filter:brightness(0) invert(1);opacity:0.7">
