...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Controle Jaarrekening VvE – Professioneel en volledig | Slimme Kascontrole', description: 'Laat de jaarrekening van uw VvE professioneel controleren. Volledig rapport in minuten. Eenmalig €59.', url: 'https://www.slimmekascontrole.nl/controle-jaarrekening-vve', images: [{ url: '/og-image.jpg', width: 1200, height: 630 }] },
  twitter: { card: 'summary_large_image', title: 'Controle Jaarrekening VvE – Professioneel en volledig | Slimme Kascontrole', images: ['/og-image.jpg'] },
}
