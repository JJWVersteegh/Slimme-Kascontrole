  ...
  <div class="container">
    ...
    <div class="taken-grid">
      ...
      <div class="taak">
        ...
        <p>Is het reservefonds conform de wettelijke vereisten opgebouwd? Upload ook het MJOP — wij analyseren de geplande onderhoudskosten per jaar en beoordelen of de huidige VvE-bijdrage toereikend is voor het geplande groot onderhoud.</p>
      </div>
      <div class="taak">
        <div class="taak-icon">📊</div>
  ...
  <div class="container" style="text-align:center">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item" style="text-align:left">
        ...
        <p>Ja. Upload het Meerjarenonderhoudsplan (PDF) als apart bestand. Wij analyseren welke werkzaamheden gepland staan, wat de geraamde kosten zijn per jaar, en of de huidige reserveringen en VvE-bijdrage toereikend zijn — of dat een verhoging nodig is.</p>
      </div>
      <div class="faq-item" style="text-align:left">
