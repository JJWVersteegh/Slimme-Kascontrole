    ...
    <div class="hero-inner">
      ...
      <div class="hero-ctas-vertical">
        <div class="hero-btn-row">
          ...
          <a href="/registreer?mode=login" style="padding:14px 24px;border-radius:8px;border:2px solid #2563EB;color:#2563EB;font-size:0.95rem;font-weight:700;text-decoration:none;font-family:'Outfit',sans-serif;background:white;white-space:nowrap;display:inline-block;">Inloggen</a>
        </div>
...
<section class="how-bg" id="hoe-het-werkt" style="background:#f8fafc">
  <div style="max-width:1100px;margin:0 auto;text-align:center">
    ...
    <h2 class="fade-in" style="text-align:center">Vier stappen naar een <em>volledig rapport</em></h2>
    ...
    <div class="contact-grid">
      ...
      <div style="display:flex;flex-direction:column;gap:20px">
        ...
        <div style="background:#dcfce7;border-radius:16px;padding:28px;border:1px solid #86efac" class="fade-in">
          <div style="font-size:1.5rem;margin-bottom:12px">💬</div>
          <h3 style="font-weight:700;color:#166534;margin-bottom:4px;font-size:1rem">WhatsApp</h3>
          <a href="https://wa.me/31624235829?text=Hallo%2C%20ik%20heb%20een%20vraag%20over%20mijn%20kascontrole." target="_blank" style="display:inline-block;margin-top:8px;background:#25D366;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;font-weight:700;font-size:0.9rem">📲 Start WhatsApp chat</a>
          <p style="font-size:0.82rem;color:#166534;margin-top:8px">Snel antwoord op uw vragen</p>
        </div>
      ...
      <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <div style="background:white;border-radius:12px;padding:20px;border:1px solid var(--border)" class="fade-in">
          ...
          <p style="font-size:0.85rem;color:var(--ink-soft);line-height:1.6">PDF, Excel (.xlsx, .xls) en CSV. Exporteer vanuit Twinq, Isabel, Yuki of uw eigen kasboek. Voor VvE's kunt u ook het MJOP (Meerjarenonderhoudsplan) als PDF uploaden — wij analyseren dan ook de geplande onderhoudskosten voor de komende jaren.</p>
        </div>
        <div style="background:white;border-radius:12px;padding:20px;border:1px solid var(--border)" class="fade-in">
