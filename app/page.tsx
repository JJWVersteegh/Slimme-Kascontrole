...
.hero-overlay{position:absolute;inset:0;background:linear-gradient(110deg,rgba(10,20,60,0.80) 0%,rgba(20,50,140,0.60) 50%,rgba(10,20,50,0.30) 100%)}
...
<section class="hero">
  <div class="hero-bg">
    <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=1800&q=85" alt="Kascontrole voor verenigingen"/>
