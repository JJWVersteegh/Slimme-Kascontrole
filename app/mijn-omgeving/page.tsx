...
export default function MijnOmgeving() {
  ...
  if (toonRapport && rapportTekstVoorWeergave) return (
    <main style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: 'Outfit, sans-serif' }}>
      <style>{`@media print { .no-print { display: none !important; } body { background: white !important; margin: 0 !important; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; } main { background: white !important; } .rapport-wrapper { box-shadow: none !important; border: none !important; border-radius: 0 !important; padding: 0 !important; max-width: 100% !important; } .rapport-table-wrap { overflow: visible !important; } table { width: 100% !important; font-size: 9pt !important; } th, td { white-space: normal !important; padding: 5px 8px !important; font-size: 9pt !important; } h2 { page-break-after: avoid; } tr { page-break-inside: avoid; } @page { size: A4 portrait; margin: 15mm; } }`}</style>
